import { ALCHEMY_API_KEY } from './alchemy';

export const CHAIN_CONFIGS = {
  '1': {
    yamlKey: 'ethereum',
    rpcEndpoint: `https://eth-mainnet.g.alchemy.com/v2/${ALCHEMY_API_KEY}`,
  ...
  '8453': {
    yamlKey: 'base',
    rpcEndpoint: `https://base-mainnet.g.alchemy.com/v2/${ALCHEMY_API_KEY}`,
  ...
  '42161': {
    yamlKey: 'arbitrum',
    rpcEndpoint: `https://arb-mainnet.g.alchemy.com/v2/${ALCHEMY_API_KEY}`,
  ...
  '137': {
    yamlKey: 'polygon',
    rpcEndpoint: `https://polygon-mainnet.g.alchemy.com/v2/${ALCHEMY_API_KEY}`,
