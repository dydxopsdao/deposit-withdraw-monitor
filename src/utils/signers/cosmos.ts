 ...
 */
async function getCosmosSigner(chainId: string, mnemonic: string): Promise<DirectSecp256k1HdWallet> {
 ...
 */
async function deriveCosmosAddress(chainId: string, mnemonic: string): Promise<string> {
